...
DROP TABLE IF EXISTS imagenes;-- TABLA IMAGENES
...
('prueba','prueba@gmail.com','123456','user');INSERT INTO imagenes (filename, originalname, mimetype, size, nombre, descripcion)
